...
<template>
    <div class="contract-area">
        ...
        <div class="d-flex justify-content-center">
            <button @click="addSwitch" type="button" class="btn btn-primary mx-5 fw-bolder m-3">更新手続き</button>
            <ModalView v-if="addModal" :title="'契約の更新手続き'" @close="addSwitch" >
                <div class="" style="height: 300px; width: 550px;">
                    <div class="row d-flex justify-content-center">
                        ...
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input type="number" aria-describedby="inputGroup-sizing-sm" class="form-control" id=""></dt>
                    </div>
                    <dl class="row d-flex justify-content-center">
                        <dt class="col-sm-3 text-primary">契約開始時間</dt>
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input type="date" aria-describedby="inputGroup-sizing-sm" class="form-control" id=""></dt>
                    </dl>
                    <dl class="row d-flex justify-content-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <button @:click="addContractDetail" type="button" class="btn btn-primary px-5">確認</button>
                    </div>
                </div>
            </ModalView>
            <button @click="delectSwitch" type="button" class="btn btn-danger mx-5 fw-bolder m-3 text-white">解約する</button>
    ...
    <div class="payment-area" style="height: 300px;">
        <div class="d-flex justify-content-center">
            ...
            <button @click="switchModal" type="button" class="btn btn-primary fw-bolder m-5 px-3 py-0 ">入金追加</button>
            <ModalView v-if="modalShow" :title="'入金情報'" @close="switchModal">
                <div class="addPayment">
                    <dl class="row d-flex justify-content-center">
                        <dt class="col-sm-2 text-primary">入金種類</dt>
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input type="text" v-model="addType" aria-describedby="inputGroup-sizing-sm" class="form-control" placeholder="賃料/礼金/敷金"></dt>
                    </dl>
                    <dl class="row d-flex justify-content-center">
                        <dt class="col-sm-2 text-primary">支払期限</dt>
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input v-model="addDate" type="date" aria-describedby="inputGroup-sizing-sm" class="form-control"></dt>
                    </dl>
                    <dl class="row d-flex justify-content-center">
                        <dt class="col-sm-2 text-primary">入金額</dt>
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input v-model="addrent" type="number" aria-describedby="inputGroup-sizing-sm" class="form-control"></dt>
                    </dl>
                    <dl class="row d-flex justify-content-center">
                        <dt class="col-sm-2 text-primary">入金日：</dt>
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input v-model="addDeadline" type="date" aria-describedby="inputGroup-sizing-sm" class="form-control"></dt>
                    </dl>
                    <dl class="row d-flex justify-content-center ">
                        <dt class="col-sm-2 text-primary">入金状態</dt>
                        <dt class="col-sm-1 text-primary">：</dt>
                        <dt class="col-sm-6"><input v-model="addStatus" type="text" aria-describedby="inputGroup-sizing-sm" class="form-control" placeholder="あり/確認中/なし"></dt>
                    </dl>
                    <div class="d-flex justify-content-center">
        ...
        <dl class="row ms-4">
            ...
            <dt class="col-sm-2">
                <button @click="reviseSwitch" type="button" class="btn btn-secondary text-white fw-bolder px-3 py-0">状態更新</button>
